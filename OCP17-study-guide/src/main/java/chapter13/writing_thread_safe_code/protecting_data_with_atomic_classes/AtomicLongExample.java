...
public class AtomicLongExample {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("getAndIncrement : " + atomicLong.getAndIncrement()); // post-increment
        System.out.println("incrementAndGet : " + atomicLong.incrementAndGet()); // pre-increment
        ...
        System.out.println("getAndDecrement : " + atomicLong.getAndDecrement()); // post-decrement
        System.out.println("decrementAndGet : " + atomicLong.decrementAndGet()); // pre-decrement
    }
}
