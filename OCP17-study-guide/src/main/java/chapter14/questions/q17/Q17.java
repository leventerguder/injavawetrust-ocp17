package chapter14.questions.q17;
...
//++    E. Files.readAttributes() is often more performant since it reads multiple attrib- utes rather than accessing individual attributes.
